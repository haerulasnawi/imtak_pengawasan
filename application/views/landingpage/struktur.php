...
<head>
    ...
    <!--========== CSS ==========-->
    <link rel="stylesheet" href="<?= base_url('assets2/'); ?>css/styles.css" type="text/css">
...
<body>
    ...
    <header class="l-header" id="header">
        <nav class="nav bd-container">
            <!-- <a href="#" class="nav__logo"><img src="<?= base_url('assets2/'); ?>img/logo_bkpsdm_new.png"></a> -->
            ...
            <div class="nav__menu" id="nav-menu">
                <ul class="nav__list">
                    ...
                    <li class="nav__item"><a href="#menu" class="nav__link">Download</a></li>
                    <li class="nav__item"><a href="#app" class="nav__link">Simutiara</a></li>
                    <li class="nav__item"><a href="#contact" class="nav__link">Hubungi Kami</a></li>
                    <li><i class='bx bx-moon change-theme' id="theme-button"></i></li>
                    <li><a class='bx bx-log-in-circle change-theme' href="<?= base_url('auth'); ?>"></a></li>
                </ul>
            </div>
    ...
    <main class="l-main">
        ...
        <section class="home" id="home">
            <div class="home__container bd-container bd-grid">
                <div class="home__data">
                    <h1 class="home__title">BKPSDM</h1>
                    <h2 class="home__subtitle">Badan Kepegawaian & Pengembangan<br> Sumber Daya Manusia</h2>
                    <a href="<?= base_url();?>" class="button">Struktur Organisasi</a>
                </div>

                <img src="<?= base_url('assets2/'); ?>img/bkpsdm.png" alt="" class="home__img">
            </div>
        </section>
        ...
        <section class="about section bd-container" id="about">
            <div class="about__container  bd-grid">
                <div class="about__data">
                    ...
                    <h2 class="section-title about__initial">We cook the best <br> tasty diet food</h2>
                    <p class="about__description">We cook the best diet food in the entire city, with excellent customer service, the best meals and at the best price, visit us.</p>
                    <a href="#" class="button">Explore history</a>
                </div>

                <img src="<?= base_url('assets2/'); ?>img/about.jpg" alt="" class="about__img">
            </div>
        </section>
        ...
        <section class="services section bd-container" id="services">
            ...
            <div class="services__container  bd-grid">
                ...
                <div class="services__content">
                    ...
                    <h3 class="services__title">Fast food low carbo</h3>
                    <p class="services__description">We offer our clients excellent quality services for many years, with the best and delicious low carbo food.</p>
                </div>
                ...
                <div class="services__content">
                    ...
                    <p class="services__description">We offer our clients excellent quality services for many years, with the best reciepe diet food in the city.</p>
                </div>
            </div>
        </section>
        ...
        <section class="menu section bd-container" id="menu">
            ...
            <div class="menu__container bd-grid">
                <div class="menu__content">
                    <img src="<?= base_url('assets2/'); ?>img/plate1.png" alt="" class="menu__img">
                ...
                <div class="menu__content">
                    <img src="<?= base_url('assets2/'); ?>img/plate2.png" alt="" class="menu__img">
                ...
                <div class="menu__content">
                    <img src="<?= base_url('assets2/'); ?>img/plate3.png" alt="" class="menu__img">
        ...
        <section class="app section bd-container" id="app">
            <div class="app__container bd-grid">
                <div class="app__data">
                    <span class="section-subtitle app__initial">Simutiara</span>
                    <h2 class="section-title app__initial">App is available</h2>
                    <p class="app__description">Temukan aplikasi kita dan silahkan didownload, aplikasi presensi yang telah mendukung sistem koordinat untuk ASN se-Kota Mataram.</p>
                    <div class="app__stores">
                        <!-- <a href="#"><img src="<?= base_url('assets2/'); ?>img/app1.png" alt="" class="app__store"></a> -->
                        <a href="#"><img src="<?= base_url('assets2/'); ?>img/download_app.png" alt="bkpsdm simutiara" class="app__store" style="max-width:40px;"></a>
                        <a href="#"><img src="<?= base_url('assets2/'); ?>img/download_app_web.png" alt="bkpsdm simutiara" class="app__store" style="max-width:40px;"></a>
                    </div>
                </div>

                <img src="<?= base_url('assets2/'); ?>img/movil-app.png" alt="" class="app__img">
            </div>
        </section>
        ...
        <section class="contact section bd-container" id="contact">
            <div class="contact__container bd-grid">
                <div class="contact__data">
                    ...
                    <p class="contact__description">If you want to more diet helps, contact us and we will attend you quickly, with our 24/7 chat service.</p>
                </div>
    ...
    <footer class="footer section bd-container">
        <div class="footer__container bd-grid">
            <div class="footer__content">
                <a href="#" class="footer__logo">BKPSDM Kota Mataram</a>
                <span class="footer__description">Melayani sepenuh hati</span>
                <div>
                    <a href="https://www.facebook.com/2012469835682408" class="footer__social"><i class='bx bxl-facebook'></i></a>
                    <a href="https://www.instagram.com/bkpsdmmataramkota/?hl=en" class="footer__social"><i class='bx bxl-instagram'></i></a>
                    <a href="https://www.youtube.com/channel/UC5DXte98Qm0gl4phrKmfkBg" class="footer__social"><i class='bx bxl-youtube'></i></a>
                </div>
            </div>
            ...
            <div class="footer__content">
                ...
                <ul>
                    <li><a href="#" class="footer__link">Delivery reciepe</a></li>
                    <li><a href="#" class="footer__link">Pricing</a></li>
                    <li><a href="#" class="footer__link">Fast diet food</a></li>
                    <li><a href="#" class="footer__link">Reserve reciepe</a></li>
                </ul>
            </div>
            ...
            <div class="footer__content">
                ...
                <ul>
                    <li>Kota Mataram - NTB</li>
                    <li>Jl. Pejanggik No. 11</li>
                    <li>0370 - 644491</li>
                    <li><a href="mailto:bkpsdm@mataramkota.go.id" class="footer__link">bkpsdm@mataramkota.go.id</a></li>
                </ul>
            </div>
        </div>

        <p class="footer__copy">&#169; 2022 Badan Kepegawaian dan Pengembangan Sumber Daya Manusia Kota Mataram</p>
    </footer>
