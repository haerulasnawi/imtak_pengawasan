...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="<?= base_url('assets2/'); ?>img/bkpsdm.png">
    <title>Online Appointment Coaching Clinic BKPSDM Kota Mataram</title>
                        ...
                        <h1 class="m-0">
                            <a href="#">
                                <svg width="50" height="50" xmlns="http://www.w3.org/2000/svg">
                                    <title>BKPSDM Kota Mataram</title>
                                    <defs>
                                    ...
                                    <g fill="none" fill-rule="evenodd">
                                        <img src="<?= base_url('assets2/'); ?>img/bkpsdm.png" class="nav__logo" alt="bkpsdm kota mataram" style="max-width:80px;">
                                    </g>
                                </svg>
                            </a>
                        </h1>
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
                        <div class="hero-copy">
                            <h1 class="hero-title mt-0">Online Appointment Coaching Clinic</h1>
                            <p class="hero-paragraph">Kita memberikan pelayanan pendampingan setiap permasalahan anda, segera daftarkan diri anda dan buatlah jadwal konsultasi dengan mentor kami.</p>
                            <div class="hero-form field field-grouped">
                                <!-- <div class="control control-expanded">
                                    <input class="input" type="email" name="email" placeholder="Your best email&hellip;">
                                </div> -->
                                <div class="control">
                                    <a class="button button-primary button-block" style="background: #1a4645; color: white;" href="<?= base_url('auth/createAccount'); ?>">Daftar Sekarang!</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <svg width="940" height="647" viewBox="0 0 940 647" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="overflow:visible">
                                    <defs>
                                        <linearGradient x1="100%" y1="0%" x2="0%" y2="100%" id="hero-illustration-a">
                                            <stop stop-color="#113030" offset="0%" />
                                            <stop stop-color="#1c4d4b" offset="100%" />
                                        </linearGradient>
                    ...
                    <div class="features-inner section-inner">
                        <div class="features-header text-center">
                            <div class="container-sm">
                                <h2 class="section-title mt-0">Coaching Clinic</h2>
                                <p class="section-paragraph">Anda dapat mengkonsultasikan berbagai permasalahan yang dapat menurunkan performa kinerja anda, seperti permasalahan hukum, kepegawaian maupun personal.</p>
                            </div>
                        </div>
                        <div class="features-wrap">
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <p class="text-sm">Aplikasi ini sangat ringan dan seamless</p>
                                </div>
                            </div>
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">Device Friendly</h4>
                                    <p class="text-sm">Akses melalui perangkat anda</p>
                                </div>
                            </div>
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">Pelayanan Prima</h4>
                                    <p class="text-sm">Operator akan menanggapi dengan segera</p>
                                </div>
                            </div>
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">Customizable</h4>
                                    <p class="text-sm">Anda dapat melakukan kustomisasi data anda</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="testimonial-inner">
                                    <div class="testimonial-main">
                                        ...
                                        <div class="testimonial-body">
                                            <p class="mb-0">Pelayanan yang baik, tingkatkan terus performa!</p>
                                        </div>
                                    </div>
                                    <div class="testimonial-footer">
                                        <div class="testimonial-link">
                                            <a href="#">@bkpsdmmataramkota</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="testimonial text-xs is-revealing">
                                <div class="testimonial-inner">
                                    <div class="testimonial-main">
                                        ...
                                        <div class="testimonial-body">
                                            <p class="mb-0">Keja bagus ton!</p>
                                        </div>
                                    </div>
                                    <div class="testimonial-footer">
                                        <div class="testimonial-link">
                                            <a href="#">@mataram.kita</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="testimonial text-xs is-revealing">
                                <div class="testimonial-inner">
                                    <div class="testimonial-main">
                                        ...
                                        <div class="testimonial-body">
                                            <p class="mb-0">Ayo daftar batur-batur!</p>
                                        </div>
                                    </div>
                                    <div class="testimonial-footer">
                                        <div class="testimonial-link">
                    ...
                    <div class="newsletter-inner section-inner">
                        ...
                        <div class="footer-form newsletter-form field field-grouped">
                            ...
                            <div class="control text-center">
                                <a class="button button-primary button-block button-shadow" style="background: #113030; color: white; width:450px;" href="#">Daftar Sekarang!</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="site-footer-inner has-top-divider">
                    <div class="brand footer-brand">
                        <a href="#">
                            <svg width="32" height="32" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <g fill="none" fill-rule="evenodd">
                                    <img src="<?= base_url('assets2/'); ?>img/bkpsdm.png" class="nav__logo" alt="bkpsdm kota mataram" style="max-width:45px;">
                                </g>
                            </svg>
                        </a>
                    </div>
                    ...
                    <ul class="footer-social-links list-reset">
                        <li>
                            <a href="https://www.facebook.com/2012469835682408">
                        ...
                        <li>
                            <a href="https://www.youtube.com/channel/UC5DXte98Qm0gl4phrKmfkBg">
                                <span class="screen-reader-text">Youtube</span>
                                <svg width="25" height="20" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M21.593 7.203a2.506 2.506 0 0 0-1.762-1.766C18.265 5.007 12 5 12 5s-6.264-.007-7.831.404a2.56 2.56 0 0 0-1.766 1.778c-.413 1.566-.417 4.814-.417 4.814s-.004 3.264.406 4.814c.23.857.905 1.534 1.763 1.765 1.582.43 7.83.437 7.83.437s6.265.007 7.831-.403a2.515 2.515 0 0 0 1.767-1.763c.414-1.565.417-4.812.417-4.812s.02-3.265-.407-4.831zM9.996 15.005l.005-6 5.207 3.005-5.212 2.995z" fill="#FFF" />
                                </svg>
                            </a>
                        </li>
                        <li>
                            <a href="https://www.instagram.com/bkpsdmmataramkota/?hl=en">
                    ...
                    <div class="footer-copyright">&copy; 2022 BKPSDM Kota Mataram</div>
                </div>
            </div>
        </footer>
    </div>
