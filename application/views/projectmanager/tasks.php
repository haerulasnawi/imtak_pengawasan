    ...
    <div class="row align-middle position-relative">
        ...
        <div class="col-lg-12">
            ...
            <body>
                ...
                <a href="" class="btn btn-primary mb-3 shadow-sm tombolTambahtask text-white border-0" style=" background: #a80231 ;" data-toggle="modal" data-target="#newTaskModal">Create a New Task</a>
                            ...
                            <?php foreach ($reqtasks as $rt) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= site_url('projectmanager/deletetask/' . $rt['id']); ?>" class="badge badge-danger" onclick="return confirm('Want to delete this stuff ?')">delete</a>
                                        <a href="<?= base_url('projectmanager/download/' . $rt['id']); ?>" class="badge badge-primary">download</a>
                                    </td>
                                </tr>
                                <?php $i++; ?>
                            <?php endforeach; ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('projectmanager'); ?>" method="post" enctype="multipart/form-data">
