<div class="container-fluid">
  ...
  <p>You can see freelance tasks ready to be invoicing here</p>
  <hr class="mb-4">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($taskinvoice as $ti) : ?>
                                <tr>
                                    ...
                                    <td><?= $ti['status']; ?></td>
                                    <td>
                                        <a href="<?= site_url('projectmanager/deletetaskfinal/' . $ti['id']); ?>" class="badge badge-danger" onclick="return confirm('Want to delete this stuff ?')">delete</a>
                                        <a href="<?= base_url('projectmanager/downloadtaskfinal/' . $ti['id']); ?>" class="badge badge-primary">download</a>
                                    </td>
                                </tr>
                                <?php $i++; ?>
                            <?php endforeach; ?>
